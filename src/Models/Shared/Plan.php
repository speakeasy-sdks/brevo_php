...
class Plan
{
     ...
     * 
     * @var \test\BREVO\Models\Shared\CreditsType $creditsType
     */
	#[\JMS\Serializer\Annotation\SerializedName('creditsType')]
    #[\JMS\Serializer\Annotation\Type('enum<test\BREVO\Models\Shared\CreditsType>')]
     ...
     * 
     * @var \test\BREVO\Models\Shared\GetAccountType $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<test\BREVO\Models\Shared\GetAccountType>')]
	...
	{
		$this->credits = 0;
		$this->creditsType = \test\BREVO\Models\Shared\CreditsType::SendLimit;
		$this->endDate = null;
		$this->startDate = null;
		$this->type = \test\BREVO\Models\Shared\GetAccountType::PayAsYouGo;
		$this->userLimit = null;
	}
}
