...
class GetContactsContacts
{
    /**
     * Set of attributes of the contact
     * 
     * @var \test\BREVO\Models\Shared\GetContactsContactsAttributes $attributes
     */
	#[\JMS\Serializer\Annotation\SerializedName('attributes')]
    #[\JMS\Serializer\Annotation\Type('test\BREVO\Models\Shared\GetContactsContactsAttributes')]
    public GetContactsContactsAttributes $attributes;
	...
	{
		$this->attributes = new \test\BREVO\Models\Shared\GetContactsContactsAttributes();
		$this->createdAt = "";
		$this->email = "";
