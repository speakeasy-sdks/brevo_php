...
class Products
{
     ...
     * 
     * @var ?\test\BREVO\Models\Shared\GetProductsMetaInfo $metaInfo
     */
	#[\JMS\Serializer\Annotation\SerializedName('metaInfo')]
    #[\JMS\Serializer\Annotation\Type('test\BREVO\Models\Shared\GetProductsMetaInfo')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetProductsMetaInfo $metaInfo = null;
