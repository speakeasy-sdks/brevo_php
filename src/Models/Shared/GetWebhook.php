...
/**
 * GetWebhook - Webhook informations
 * 
...
class GetWebhook
{
     ...
     * 
     * @var \test\BREVO\Models\Shared\GetWebhookType $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<test\BREVO\Models\Shared\GetWebhookType>')]
    public GetWebhookType $type;
	...
	public function __construct()
	{
		...
		$this->id = 0;
		$this->modifiedAt = "";
		$this->type = \test\BREVO\Models\Shared\GetWebhookType::Marketing;
		$this->url = "";
	}
}
